...
type
  ...
  public
    function Boot(const filename: string): IDesignMapEngine;
  end;
...
function TdmProjectBoot.Boot(const filename: string): IDesignMapEngine;
begin
   ...
   result := retrieveEngine(et_map, dsBootEngineName.Value, TVersion.Create(dsBootversion.Value)) as IDesignMapEngine;
   dsBoot.Close;
   connection.Close;
end;
