...
type
  TDatasetList = TList<TClientDataSet>;
   ...
   TdmDatabase = class(TDataModule)
      ...
      charClasses_skillsetmethod: TADTField;
      charClasses_skillsetmethodarrayArgs: TBooleanField;
      charClasses_skillsetskill: TIntegerField;
      charClasses_skillsetstyle: TIntegerField;
      charClasses_skillsetmethod_displayAddress: TIntegerField;
      ...
      charClassescommand: TArrayField;
      ...
      charClassesexpVars: TArrayField;
      ...
      charClasses_skillsetmethodmethod_style: TIntegerField;
      ...
      charClasses_skillsetmethodmethod_address: TIntegerField;
      ...
      charClasses_skillsetmethodmethod_name: TStringField;
