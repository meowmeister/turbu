unit sdl;
{
  $Id: sdl.pas,v 1.37 2007/12/20 22:36:56 savage Exp $
...
{ This function sets up a filter to process all events before they
  ...
  TSDL_Rect = record
    x, y: SInt16;
    w, h: UInt16;
    class operator implicit(a: TRect): TSDL_Rect; overload;
    class operator implicit(a: TSDL_Rect): TRect; overload;
  end;
...
//  TSDL_ColorArray = array[0..65000] of TSDL_Color;
  TSDL_ColorArray = array[0..255] of TSDL_Color;
...
class operator TSDL_Rect.implicit(a: TRect): TSDL_Rect;
begin
   result.x := a.Left;
   result.y := a.Top;
   result.w := a.Right;
...
class operator TSDL_Rect.implicit(a: TSDL_Rect): TRect;
begin
   result.Left := a.x;
   result.Top := a.y;
   result.Right := a.w;
